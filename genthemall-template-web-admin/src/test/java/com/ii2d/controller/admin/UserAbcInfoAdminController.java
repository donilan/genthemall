...
public class UserAbcInfoAdminController extends com.ii2d.dbase.web.controller.AbstractController {
	...
	public @ResponseBody String create(@ModelAttribute(value="userAbcInfo") UserAbcInfo instance) {
		commonService.insert(instance);
		return "success";
	}
	
	@RequestMapping(method = RequestMethod.PUT, value="{id}")
	public @ResponseBody String update(@ModelAttribute(value="userAbcInfo") UserAbcInfo instance) {
